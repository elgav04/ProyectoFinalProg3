...
import { brokers } from 'src/app/interfaces/user.interface';
...
export class BrokersComponent implements OnInit {
  ...
  AgregarValor(){
    ...
    delete this.user.cbroker;   
    this.Data.save(this.user,'/brokers')
        .subscribe(
          res => {
          this.getUser();
