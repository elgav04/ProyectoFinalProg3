...
import { tipousuarios } from 'src/app/interfaces/user.interface';
...
export class TipousuariosComponent implements OnInit {
  ...
  AgregarValor(){
    ...
    delete this.user.ctipousuario;   
    this.Data.save(this.user,'/tipousuarios')
       .subscribe(
         res => {
          this.getUser();
  ...
  EliminarData(id: number){
    this.Data.delete(id, '/tipousuarios')
      .subscribe(
        res => {
          this.getUser();
