...
import { tipoempleado } from 'src/app/interfaces/user.interface';
...
export class TipoempleadoComponent implements OnInit {
  ...
  AgregarValor(){
    ...
    delete this.user.ctipoemp;   
    this.Data.save(this.user,'/tipoempleado')
        .subscribe(
          res => {
          this.getUser();
  ...
  EliminarData(id: number){
    this.Data.delete(id, '/tipoempleado')
      .subscribe(
        res => {
          this.getUser();
