...
import { tipoempleado } from '../../interfaces/user.interface';
...
@Component({
  selector: 'app-tipoempleado-edit',
  templateUrl: './tipoempleado-edit.component.html',
  styleUrls: ['./tipoempleado-edit.component.css']
})
export class TipoempleadoEditComponent implements OnInit {
  ...
  constructor(private Data: DataService,
    ...
    ngOnInit(): void {
      ...
      if (params['id']) {
        this.Data.getOne(params['id'],'/tipoempleado')
          .subscribe(
            (res: any) => {
              if (res.fecha) {
    ...
    updateUser() {
      ...
      this.Data.update(this.user.ctipoemp!, this.user,'/tipoempleado')
        .subscribe(
          res => {
